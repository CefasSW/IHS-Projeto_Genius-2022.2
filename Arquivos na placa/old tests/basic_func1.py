...
def main():
  ...
  if(r_disp(test_val, fd) == 0):
    print("Numero %d no display da direita" %test_val)
  
  if(r_disp_digit(test_digit, test_pos, fd) == 0):
    print("Mudou para %d o display %d da direita" %(test_digit, test_pos))
